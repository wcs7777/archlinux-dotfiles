...
map('n', '<Leader>cl', 'guiw', 'Lower case inner word')
map('n', '<Leader>cu', 'gUiw', 'Upper case inner word')
...
map('v', '<M-j>', [[:m '>+1<CR>gv=gv]], 'Move selection below')
map('v', '<M-k>', [[:m '<-2<CR>gv=gv]], 'Move selection above')
