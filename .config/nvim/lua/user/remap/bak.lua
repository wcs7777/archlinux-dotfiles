...
map('v', '<Leader>cto', ":'<,'>!column -t -o ' '<CR>", 'Format as table')
map({'n', 'v'}, '<Leader>d', '"_d', 'Delete to black hole register')
map({'n', 'v'}, '<Leader>y', '"+y', 'Yank to system clipboard')
map({'n', 'v'}, '<Leader>Y', '"+Y', 'Yank to end of line to system clipboard')
...
map('n', '<Leader>ucc', fn(toggle_option, 'colorcolumn', { {}, { '+0' } }), 'Toggle colorcolumn')
